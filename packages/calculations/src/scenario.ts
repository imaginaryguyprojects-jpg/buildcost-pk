...
export function simulatePriceScenario(
  ...
  for (const mat of base.materials) {
    ...
    if (mat.materialId === "cement") adjustmentFactor += adjustments.cementPct / 100;
    else if (mat.materialId === "steel") adjustmentFactor += adjustments.steelPct / 100;
    else if (mat.materialId === "bricks") adjustmentFactor += adjustments.bricksPct / 100;
    else if (mat.category === "finishing") adjustmentFactor += adjustments.finishingPct / 100;
