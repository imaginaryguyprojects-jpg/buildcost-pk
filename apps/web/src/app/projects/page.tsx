  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white tracking-tight">Construction Projects</h1>
          <p className="text-xs text-slate-400 mt-1">
            Manage your residential and commercial estimation workspaces
          </p>
        </div>

        <Link
          href="/projects/new"
          className="flex items-center gap-2 px-4 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl text-xs font-semibold shadow-md shadow-emerald-950/40 transition-all self-start sm:self-auto"
        >
        ...
        {filteredProjects.map((project) => {
          ...
          return (
            <div
              key={project.id}
              className={cn(
                "bg-slate-900/90 border rounded-2xl p-5 shadow-sm flex flex-col justify-between transition-all",
                isActive
            ...
            >
              <div>
                <div className="flex items-start justify-between gap-2 mb-3">
                  ...
                  <span className="text-[10px] uppercase font-bold tracking-wider px-2 py-0.5 rounded-md bg-slate-800 text-emerald-400 border border-slate-700">
