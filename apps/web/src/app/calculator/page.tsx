...
export default function CalculatorHubPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-white tracking-tight">Construction Calculators</h1>
        ...
        {calculators.map((calc) => {
          ...
          return (
            <Link
              key={calc.href}
              href={calc.href}
              className="bg-slate-900/90 border border-slate-800 hover:border-emerald-500/60 rounded-2xl p-6 shadow-sm flex flex-col justify-between transition-all group"
            >
              <div>
                <div className="flex items-start justify-between mb-4">
                  <div className="w-11 h-11 rounded-xl bg-slate-800 flex items-center justify-center text-emerald-400 group-hover:bg-emerald-600 group-hover:text-white transition-colors">
                ...
                <h3 className="font-bold text-slate-100 text-base mb-1.5 group-hover:text-emerald-300 transition-colors">
                  {calc.title}
                </h3>
              ...
              <div className="flex items-center gap-1 text-xs font-semibold text-emerald-400 mt-6 pt-3 border-t border-slate-800/60">
      ...
      <div className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-5 flex items-start gap-3.5">
        <ShieldAlert className="w-5 h-5 text-amber-400 shrink-0 mt-0.5" />
        <div className="text-xs text-slate-400 leading-relaxed">
          <span className="font-bold text-slate-300 block mb-1">Civil Engineering Disclaimer</span>
