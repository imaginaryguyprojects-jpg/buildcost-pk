  ...
  return (
    <header className="h-16 bg-white/95 dark:bg-slate-950/95 border-b border-slate-200 dark:border-slate-800/80 px-4 md:px-8 flex items-center justify-between sticky top-0 z-40 backdrop-blur-md transition-colors">
      ...
      <div className="flex items-center gap-2.5">
        ...
        {/* PRO / Plan Branding & Upgrade CTA (Sections 1 & 2) */}
        {(() => {
          const isPro =
            user?.plan === "pro" ||
            user?.plan === "business" ||
        ...
        <Link
          href="/admin"
          className="flex items-center gap-1.5 px-2.5 py-1.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-900 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-800 rounded-lg text-xs font-bold transition-all shadow-xs"
